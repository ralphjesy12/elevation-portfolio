<div id="section-groups">
    <section id="galaxy" class=" dark nopadding section-snap" data-anchor="galaxy">
        <?php
        get_template_part('partials/content','welcome');
        ?>
    </section>
    <section id="about-me" class="nopadding section-snap" data-anchor="font-jaapokki-reg">
        <?php
